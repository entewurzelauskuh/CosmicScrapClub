...
- [ ] **Step 4: Play-test rocket impact** — fire a rocket at a target. On hit, a bright warm spark + (if hit was top-facing) a tan dust puff should appear. No tracer / smoke yet — those are next tasks.
